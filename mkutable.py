...
force_compose = set()
force_compose.add(range(0x1160, 0x11ff +1))
force_compose.add(range(0xd7b0, 0xd7c6 +1))
force_compose.add(range(0xd7cb, 0xd7fb +1))
...
def print_uni_file(datafile):
    ...
    print("/* Generated by", '"mkutable.py', ' '.join(sys.argv[1:]), '" on', datetime.datetime.utcnow().isoformat(timespec='seconds'), "*/")
